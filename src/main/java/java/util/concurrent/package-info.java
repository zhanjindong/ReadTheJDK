 ...
 * {@link vjava.util.concurrent.locks} and
 * {@link vjava.util.concurrent.atomic} packages.
 *
 * <h2>Executors</h2>
 *
 * <b>Interfaces.</b>
 *
 * {@link vjava.util.concurrent.Executor} is a simple standardized
 * interface for defining custom thread-like subsystems, including
 * thread pools, asynchronous IO, and lightweight task frameworks.
 * Depending on which concrete Executor class is being used, tasks may
 * execute in a newly created thread, an existing task-execution thread,
 * or the thread calling {@link vjava.util.concurrent.Executor#execute
 * execute}, and may execute sequentially or concurrently.
 *
 * {@link vjava.util.concurrent.ExecutorService} provides a more
 * complete asynchronous task execution framework.  An
 * ExecutorService manages queuing and scheduling of tasks,
 * and allows controlled shutdown.
 *
 * The {@link vjava.util.concurrent.ScheduledExecutorService}
 ...
 * function expressed as {@link vjava.util.concurrent.Callable},
 * the result-bearing analog of {@link java.lang.Runnable}.
 *
 * A {@link vjava.util.concurrent.Future} returns the results of
 * a function, allows determination of whether execution has
 * completed, and provides a means to cancel execution.
 *
 * A {@link vjava.util.concurrent.RunnableFuture} is a {@code Future}
 ...
 * <b>Implementations.</b>
 *
 * Classes {@link vjava.util.concurrent.ThreadPoolExecutor} and
 * {@link vjava.util.concurrent.ScheduledThreadPoolExecutor}
 * provide tunable, flexible thread pools.
 *
 * The {@link vjava.util.concurrent.Executors} class provides
 * factory methods for the most common kinds and configurations
 * of Executors, as well as a few utility methods for using
 * them.  Other utilities based on {@code Executors} include the
 * concrete class {@link vjava.util.concurrent.FutureTask}
 * providing a common extensible implementation of Futures, and
 * {@link vjava.util.concurrent.ExecutorCompletionService}, that
 * assists in coordinating the processing of groups of
 * asynchronous tasks.
 *
 * <p>Class {@link vjava.util.concurrent.ForkJoinPool} provides an
 * Executor primarily designed for processing instances of {@link
 * vjava.util.concurrent.ForkJoinTask} and its subclasses.  These
 ...
 * <h2>Queues</h2>
 *
 * The {@link vjava.util.concurrent.ConcurrentLinkedQueue} class
 * supplies an efficient scalable thread-safe non-blocking FIFO
 * queue.
 *
 * <p>Five implementations in {@code vjava.util.concurrent} support
 * the extended {@link vjava.util.concurrent.BlockingQueue}
 * interface, that defines blocking versions of put and take:
 * {@link vjava.util.concurrent.LinkedBlockingQueue},
 * {@link vjava.util.concurrent.ArrayBlockingQueue},
 * {@link vjava.util.concurrent.SynchronousQueue},
 * {@link vjava.util.concurrent.PriorityBlockingQueue}, and
 * {@link vjava.util.concurrent.DelayQueue}.
 * The different classes cover the most common usage contexts
 * for producer-consumer, messaging, parallel tasking, and
 * related concurrent designs.
 *
 * <p> Extended interface {@link vjava.util.concurrent.TransferQueue},
 * and implementation {@link vjava.util.concurrent.LinkedTransferQueue}
 * introduce a synchronous {@code transfer} method (along with related
 * features) in which a producer may optionally block awaiting its
 * consumer.
 *
 * <p>The {@link vjava.util.concurrent.BlockingDeque} interface
 * extends {@code BlockingQueue} to support both FIFO and LIFO
 * (stack-based) operations.
 * Class {@link vjava.util.concurrent.LinkedBlockingDeque}
 * provides an implementation.
 *
 * <h2>Timing</h2>
 *
 * The {@link vjava.util.concurrent.TimeUnit} class provides
 ...
 * <ul>
 *
 * <li>{@link vjava.util.concurrent.Semaphore} is a classic concurrency tool.
 *
 * <li>{@link vjava.util.concurrent.CountDownLatch} is a very simple yet
 * very common utility for blocking until a given number of signals,
 * events, or conditions hold.
 *
 * <li>A {@link vjava.util.concurrent.CyclicBarrier} is a resettable
 * multiway synchronization point useful in some styles of parallel
 * programming.
 *
 * <li>A {@link vjava.util.concurrent.Phaser} provides
 * a more flexible form of barrier that may be used to control phased
 * computation among multiple threads.
 *
 * <li>An {@link vjava.util.concurrent.Exchanger} allows two threads to
 ...
 * {@link vjava.util.concurrent.ConcurrentHashMap},
 * {@link vjava.util.concurrent.ConcurrentSkipListMap},
 * {@link vjava.util.concurrent.ConcurrentSkipListSet},
 * {@link vjava.util.concurrent.CopyOnWriteArrayList}, and
 * {@link vjava.util.concurrent.CopyOnWriteArraySet}.
 ...
 * vjava.util.concurrent.ConcurrentHashMap} is "concurrent".  A
 ...
 *
 *
 * The methods of all classes in {@code vjava.util.concurrent} and its
